...
{
    //sudo add if anything is being transmitted to the controller
    ...
    //sudo edit if anything is being transmitted to the controller
    ...
    //sudo delete if anything is being transmitted to the controller
